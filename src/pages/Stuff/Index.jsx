                ...
                {stuffs.map((stuff, id) => (
                  <tr key={stuff.id} className="border-b dark:border-neutral-500">
                    ...
                    <td className="whitespace-nowrap px-6 py-4">
                      <Link to={`/stuff/${stuff.id}/show`} className="px-4 py-2 bg-blue-500 rounded-lg mr-2 font-bold text-white">Show</Link>
                      <Link to={"/stuff/edit/" + stuff.id} className="px-4 py-2 bg-green-500 rounded-lg mr-2 font-bold text-white">Edit</Link>
